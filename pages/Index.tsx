...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2E86AB] to-[#A23B72] flex items-center justify-center p-4">
